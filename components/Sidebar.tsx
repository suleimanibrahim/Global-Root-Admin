...
const Sidebar: React.FC = () => {
  const navItems = [
    ...
    { name: 'Member Requests', icon: 'person_add', path: '/member-requests' },
      ...
      <div className="flex flex-col h-full p-4">
        ...
        <div className="flex items-center gap-3 px-2 mb-6">
          ...
          <div className="flex flex-col">
            <h1 className="text-gray-900 dark:text-white text-sm font-medium leading-normal">{CURRENT_USER.name}</h1>
            <p className="text-gray-500 dark:text-gray-400 text-xs font-normal leading-normal">{CURRENT_USER.role}</p>
          </div>
        </div>
        ...
        <div className="mt-auto pt-4">
           <button className="flex w-full items-center justify-center rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold tracking-wide hover:bg-primary-hover transition-colors shadow-lg shadow-primary/20">
            <span className="truncate">Create New Community</span>
          </button>
        </div>
